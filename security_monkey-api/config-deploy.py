...
SECRET_KEY = 'wkdiensjwentbdhwaslk'

MAIL_DEFAULT_SENDER =  'secmontest@dwolla.com'
SECURITY_REGISTERABLE = True
SECURITY_CONFIRMABLE = False
SECURITY_RECOVERABLE = False
SECURITY_PASSWORD_HASH = 'bcrypt'
SECURITY_PASSWORD_SALT = 'kjfdhkhasqpeoznxcvsbndf'
...
SECURITY_TEAM_EMAIL = ['chen@dwolla.com']
